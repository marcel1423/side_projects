    ...
    void Vypis() throws IOException {
        ...
        do {
            ...
            switch ((int) Nacti_cislo.Nacitani()) {
                case 1:
                    System.out.println("Objem krychle je: " + Vypocet_objemu());
                    break;
                case 2:
                    System.out.println("Povrch krychle je: " + Vypocet_povrchu());
                    break;
                case 3:
                    System.out.println("Telesova Uhlopricka krychle je: " + Telesova_uhlopricka());
                    break;
                case 4:
                    System.out.println("Stenova uhlopricka krychle je: " + Stenova_uhlopricka());
                default:
                    System.out.println("Zadej 1 - 3!");
                    vypni = true;
            }
        } while (vypni);
    }
