    ...
    void Vypis() throws IOException {
        ...
        do {
            ...
            switch ((int) Nacti_cislo.Nacitani()) {
                case 1:
                    System.out.println("Objem kvadru je: " + Vypocet_objemu());
                    break;
                case 2:
                    System.out.println("Povrch kvadru je: " + Vypocet_povrchu());
                    break;
                case 3:
                    System.out.println("Telesova Uhlopricka kvadru je: " + Telesova_uhlopricka());
                    break;
                case 4:
                    System.out.println("Stenova uhlopricka kvadru je: " + Stenova_uhlopricka());
                default:
